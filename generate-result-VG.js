...
const inputJson = fs.readFileSync('boats-VG.json', 'utf8');
const inputTracks = fs.readFileSync('tracks-VG.json', 'utf8');
...
fs.writeFileSync('boats_result_VG.json', resultJson, 'utf8');
