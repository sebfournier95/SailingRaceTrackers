...
const inputJson = fs.readFileSync('boats-AUCB.json', 'utf8');
const inputTracks = fs.readFileSync('tracks-AUCB.json', 'utf8');
...
fs.writeFileSync('boats_result_AUCB.json', resultJson, 'utf8');
