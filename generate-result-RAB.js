...
const inputJson = fs.readFileSync('boats-RAB.json', 'utf8');
const inputTracks = fs.readFileSync('tracks-RAB.json', 'utf8');
...
fs.writeFileSync('boats_result_RAB.json', resultJson, 'utf8');
